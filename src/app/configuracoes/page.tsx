  ...
  return (
    <div className="page-enter space-y-4">
            ...
            <table className="table-zebra min-w-full text-left text-xs">
              <thead>
                <tr className="border-b border-slate-200">
                  <th scope="col" className="px-2 py-2">Papel</th>
                  {permissionActions.map((action) => (
                    <th scope="col" key={action} className="px-2 py-2">
                      {action}
                    </th>
                  ))}
                </tr>
      ...
      <section className="panel p-4">
        ...
        <div className="mt-3 overflow-auto">
          <table className="table-zebra min-w-full text-left text-xs">
            <thead>
              <tr className="border-b border-slate-200">
                <th scope="col" className="px-2 py-2">Regra</th>
                <th scope="col" className="px-2 py-2">Escopo</th>
                <th scope="col" className="px-2 py-2">Tipo</th>
                <th scope="col" className="px-2 py-2">Valor/hora</th>
                <th scope="col" className="px-2 py-2">Diaria</th>
                <th scope="col" className="px-2 py-2">Valor/turno</th>
                <th scope="col" className="px-2 py-2">Qtd turnos padrao</th>
              </tr>
            </thead>
            <tbody>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr,1.2fr]">
        <div className="panel p-4">
          <h3 className="text-base font-semibold text-slate-800">Templates por empresa/unidade/time</h3>
          <ul className="mt-2 space-y-2 text-xs text-slate-600">
